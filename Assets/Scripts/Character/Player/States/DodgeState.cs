...
public class DodgeState : PlayerState
{
    ...
    public override StateTransition[] GetTransitions()
    {
        ...
        {
            new StateTransition(PlayerStateManager.MOVING_STATE, () => stateManager.TimeInState >= stateManager.PlayerControlDataSO.DodgeDuration),
    ...
    private bool ToSwordSpin()
    {
        ...
        bool inWindow = stateManager.TimeInState < stateManager.PlayerControlDataSO.SwordSpinWindow;

...
public class LandingState : PlayerState
{
    ...
    public override StateTransition[] GetTransitions()
    {
        ...
        {
            new StateTransition(PlayerStateManager.MOVING_STATE, () => stateManager.TimeInState > stateManager.PlayerControlDataSO.LandingDuration || stateManager.DefaultMovementModule.MoveVec.magnitude > 0),
            new StateTransition(PlayerStateManager.IDLE_STATE, () => stateManager.TimeInState > stateManager.PlayerControlDataSO.LandingDuration),
